...
.loginform{width:320px;margin:50px;border: 1px solid #ddd;border-radius:5px;
...
.widget h3{
  ...
  border-bottom:2px solid #066cd2;
  text:#000;
  margin:0 0 3px;
  padding:5px;
...
.adminright{width:575px;float:right;padding:5px 10px;
background:#fefefe}
